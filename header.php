...
<head>
    ...
    <meta name="keywords" content="заказать сайт, создание сайтов, разработка сайтов, сайт под ключ, веб, wordpress, лендинг" />
...
<header class="header">
    <div class="header__content container">
       ...
       <div class="header__phone">
           <noindex>
        <a target="_blank" rel="nofollow" aria-label="viber link" href="https://viber.click/<?php echo $websitesmaster['vb']; ?>"><i class="icon-viber"></i>Viber</a>
           </noindex>
           <noindex>
        <a target="_blank" rel="nofollow" aria-label="whatsapp link" href="https://wa.clck.bar/<?php echo $websitesmaster['wh']; ?>"><i class="icon-whatsapp"></i>WhatsApp</a>
           </noindex>
       </div>
       <div class="header__button">
           <noindex>
        <a target="_blank" rel="nofollow" href="https://t.me/<?php echo $websitesmaster['tg']; ?>" class="header__but but-animete site-button"><i class="icon-telegram-plane"></i> Задать вопрос</a>
           </noindex>
       </div>
    </div>
</header>
