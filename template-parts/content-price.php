...
<div class="homePrice__item cart-item back-gr-v">
                <div class="bg-bl">
                    <div class="homePrice__item-left">
                        ...
                        <p class="homePrice__item-price"><?php echo $value['price-price']; ?><i class="icon-ruble-sign"></i></p>
                    </div>
                    <div class="homePrice__item-right">
                        ...
                        <div class="homePrice__item-button">
                            <noindex>
                            <a target="_blank" rel="nofollow" href="https://t.me/<?php echo $websitesmaster['tg']; ?>" class="homePrice__item-but but-animete site-button"><i class="icon-telegram-plane"></i> Задать вопрос</a>
                            </noindex>
                        </div>
                    </div>
                </div>
