    ...
    <div class="popup__body back-gr popup__show">
        ...
        <div class="popup__content">
            ...
            <div id="popup__right" class="popup__right">
                ...
                <p class="popup__desc"><?php echo $websitesmaster['pop-price']; ?><i class="icon-ruble-sign"></i></p>
                <div class="popup__button">
                    <noindex>
                    <a target="_blank" rel="nofollow" href="https://t.me/<?php echo $websitesmaster['tg']; ?>" class="popup__but site-button but-animete"><i class="icon-telegram-plane"></i>Сделать заказ</a>
                    </noindex>
                </div>
            </div>
        </div>
...
<?php get_template_part( 'template-parts/content', 'action' ); ?>
</div><!--main wrapp-->
<?php wp_footer(); ?>
<?php 
